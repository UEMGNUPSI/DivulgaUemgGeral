      ...
      ?>
        <tr>
          ...
          <td>
            ...
            <button class="btn btn-primary mr-3" title="Negar solicitação" type="button"><i class="fas fa-user-times"></i></button>
            <button class="btn btn-primary mr-3" title="Aceitar solicitação" type="button"><i class="fas fa-check-circle"></i></button>
          </td>
        </tr>
