      ...
      <div class="col-12">
        ...
        while ($dados = mysqli_fetch_assoc($consulta)) {
          ...
          <form class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 ">
            ...
            <button type="submit" class="btn mb-3" formaction="adminUnidade.php" style="width: 100%; margin-bottom:15px;background-color: rgba(60, 110, 143, 0.96);color: white"><?php echo $dados['unidades']; ?>
            </button>
      ...
      <div class="modal-content">
        ...
        <div id="Logar" class="tab">
          ...
          <div class="modal-header" style="background-color: rgba(60, 110, 143, 0.96);">
            ...
            <h4 class="modal-title" style="color: white"><span id="icon-login" class="glyphicon glyphicon-user" style="padding-right: 8px;color: white;"></span>Cadastrar Unidade</h4>
